...
<head>
    ...
    <title>Tambah Kebutuhan Material</title>
</head>
    ...
    <div class="row">
        <div class="col-md-8 offset-md-2">
                <div class="card-body">
                    ...
                    <form action="{{url('lahan/simpan_material/{id}')}}" method="POST" enctype="multipart/form-data">
                {{ csrf_field() }}
                @foreach ($sdm as $sdm)
                ...
                <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="input" name="keterangan" class="form-control form-control-user" rows="4" placeholder="keterangan">
                        </div>
