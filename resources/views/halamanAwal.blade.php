...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="/G1.jpg"  class="d-block w-100" height="600" alt="Bunga Matahari">
            </div>
            <div class="carousel-item">
                <img src="/G2.jpg" class="d-block w-100" height="600" alt="Kapal Berlayar">
            </div>
            <div class="carousel-item">
                <img src="/G3.jpg" class="d-block w-100" height="600" alt="Danau">
            </div>
        </div>
